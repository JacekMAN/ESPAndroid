       ...
       wspolne();
        switch (topic) {
            ...
            case "S11/dane3" :
                ...
                if (piwnica != 1){temp18.setText(pomiar);}
            ...
            case "A0/dane9":
                ...
                EBaza.putString ("alarm1", a);EBaza.commit();
            ...
            case "S5/dane1":
                ...
                if (otw11 == 1) { prom.setBackgroundColor(Color.rgb(199, 45, 45));}
                 else {prom.setBackgroundColor(Color.rgb(31, 135, 45));}
                 break;
            ...
            case "A0/dane0":
                ...
                if (otw11 == 0) { if (promieniowanie.equals("tak")){
                    pro2.setTextColor(Color.BLACK);
                    getPromieniowanie((TextView) findViewById(R.id.pro4));
                }}
                    else { prom1.setBackgroundColor(Color.rgb(199, 45, 45));
                    pro2.setTextColor(Color.WHITE);pro2.setText ("ALARM");
            ...
            case "S5/dane2":
                ...
                if (otw11 == 1) { promm.setBackgroundColor(Color.rgb(199, 45, 45));}
                else {promm.setBackgroundColor(Color.rgb(31, 135, 45));}
                break;
            ...
            case "S8/dane1":
                ...
                if (piwnica == 1) {
                    ...
                    alP.setTextColor(Color.WHITE); alP2.setTextColor(Color.YELLOW);
                    alP.setText("Piwnica otwarta");
                }  else
                {Obraz313.setBackgroundColor(Color.WHITE);alP.setTextColor(Color.BLACK);alP.setText(pomiar);alP2.setTextColor(Color.BLACK); }
                break;
