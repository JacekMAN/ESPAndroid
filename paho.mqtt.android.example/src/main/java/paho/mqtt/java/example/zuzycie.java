...
import static paho.mqtt.java.example.R.id.checkbox;
...
////uiouoiui-------------------------------------------------------------------------------------------------------
        ...
        zadminus6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (zadana10>1){zadana10 = zadana10-1;}
                zadana10 = zadana10/10;
        ...
        zadplus6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                zadana10=zadana10 *10;
                if (zadana10<20){zadana10 = zadana10+1;}
                zadana10 = zadana10/10;
        ...
        wy0.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (parametr[1]!=1 ){publishMessage("Piec8", "1");}
                if (parametr[1]==1 ){publishMessage("Piec8", "0");}
            }
        });
        CheckBox wy1 = (CheckBox) findViewById(R.id.czasowe5);
        wy1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (parametr[0]!=1 ){publishMessage("Piec7", "1");}
                if (parametr[0]==1 ){publishMessage("Piec7", "0");}
            }
        });
        CheckBox wy2 = (CheckBox) findViewById(R.id.czasowe1);
        wy2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (parametr[2]!=1 ){publishMessage("Piec9", "1");}
                if (parametr[2]==1 ){publishMessage("Piec9", "0");}
            }
        });
        CheckBox wy3 = (CheckBox) findViewById(R.id.czasowe2);
        wy3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (parametr[3]!=1 ){publishMessage("Piec10", "1");}
                if (parametr[3]==1 ){publishMessage("Piec10", "0");}
            }
        });
        CheckBox wy4 = (CheckBox) findViewById(R.id.czasowe3);
        wy4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (parametr[4]!=1 ){publishMessage("Piec11", "1");}
                if (parametr[4]==1 ){publishMessage("Piec11", "0");}
            }
        });
    ...
    private void dosalemWiadomosc(String topic, String message) {
            ...
            switch (topic) {
                ...
                case "Piec12":
                    ...
                    if (p12==1) {       wybor3.setChecked(true);wybor2.setChecked(false);wybor1.setChecked(false);};
                    if (p12==2) {       wybor2.setChecked(true);wybor3.setChecked(false);wybor1.setChecked(false);};
                    if (p12==0) {       wybor1.setChecked(true);wybor2.setChecked(false);wybor3.setChecked(false);};
                ...
                case "Piec8":
                    ...
                    if (wybor == 0){parametr[1]=0;CheckBox wy0 = (CheckBox) findViewById(R.id.czasowe0);wy0.setChecked(true);wy0.setText("ON");TextView piec13 = (TextView) findViewById(R.id.textpiec2);piec13.setTextColor(Ok);TextView piec30 = (TextView) findViewById(R.id.piec13);piec30.setTextColor(Ok);}
                    if (wybor != 0){parametr[1]=1; CheckBox wy1 = (CheckBox) findViewById(R.id.czasowe0);wy1.setChecked(false);wy1.setText("OFF");TextView piec13 = (TextView) findViewById(R.id.textpiec2);piec13.setTextColor(Czerwony);TextView piec30 = (TextView) findViewById(R.id.piec13);piec30.setTextColor(Czerwony);}


                    break;
                case "Piec7":
                    Double wybor5 = new Double(message);
                    if (wybor5 == 0){parametr[0]=0;CheckBox wy0 = (CheckBox) findViewById(R.id.czasowe5);wy0.setChecked(true);wy0.setText("ON");TextView piec13 = (TextView) findViewById(R.id.textpiec7);piec13.setTextColor(Ok);TextView piec30 = (TextView) findViewById(R.id.piec30);piec30.setTextColor(Ok);}
                    if (wybor5 != 0){parametr[0]=1;CheckBox wy1 = (CheckBox) findViewById(R.id.czasowe5);wy1.setChecked(false);wy1.setText("OFF");TextView piec13 = (TextView) findViewById(R.id.textpiec7);piec13.setTextColor(Czerwony);TextView piec30 = (TextView) findViewById(R.id.piec30);piec30.setTextColor(Czerwony);}

                    break;
                case "Piec9":
                    Double wyb1 = new Double(message);
                    if (wyb1 == 0){parametr[2]=0;CheckBox wy0 = (CheckBox) findViewById(R.id.czasowe1);wy0.setChecked(true);wy0.setText("ON");TextView piec13 = (TextView) findViewById(R.id.textpiec3);piec13.setTextColor(Ok);TextView piec30 = (TextView) findViewById(R.id.piec19);piec30.setTextColor(Ok);}
                    if (wyb1 != 0){parametr[2]=1; CheckBox wy0 = (CheckBox) findViewById(R.id.czasowe1);wy0.setChecked(false);wy0.setText("OFF");TextView piec13 = (TextView) findViewById(R.id.textpiec3);piec13.setTextColor(Czerwony);TextView piec30 = (TextView) findViewById(R.id.piec19);piec30.setTextColor(Czerwony);}


                    break;
                case "Piec10":
                    Double wyb2 = new Double(message);
                    if (wyb2 == 0){parametr[3]=0;CheckBox wy0 = (CheckBox) findViewById(R.id.czasowe2);wy0.setChecked(true);wy0.setText("ON");TextView piec13 = (TextView) findViewById(R.id.textpiec4);piec13.setTextColor(Ok);TextView piec30 = (TextView) findViewById(R.id.piec24);piec30.setTextColor(Ok);}
                    if (wyb2 != 0){parametr[3]=1; CheckBox wy0 = (CheckBox) findViewById(R.id.czasowe2);wy0.setChecked(false);wy0.setText("OFF");TextView piec13 = (TextView) findViewById(R.id.textpiec4);piec13.setTextColor(Czerwony);TextView piec30 = (TextView) findViewById(R.id.piec24);piec30.setTextColor(Czerwony);}
                ...
                case "Piec11":
                    ...
                    if (wyb3 == 0){parametr[4]=0;CheckBox wy0 = (CheckBox) findViewById(R.id.czasowe3);wy0.setChecked(true);wy0.setText("ON");TextView piec13 = (TextView) findViewById(R.id.textpiec5);piec13.setTextColor(Ok);TextView piec30 = (TextView) findViewById(R.id.piec29);piec30.setTextColor(Ok);}
                    if (wyb3 != 0){parametr[4]=1; CheckBox wy0 = (CheckBox) findViewById(R.id.czasowe3);wy0.setChecked(false);wy0.setText("OFF");TextView piec13 = (TextView) findViewById(R.id.textpiec5);piec13.setTextColor(Czerwony);TextView piec30 = (TextView) findViewById(R.id.piec29);piec30.setTextColor(Czerwony);}
